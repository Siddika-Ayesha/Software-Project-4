...
import OshKoshMe from '../media/me.jpg'
import OshKoshClass from '../media/class.jpg';
import OshKoshPlane from '../media/plane.jpg';
import ThreeToTwoDataPanelOpen from '../media/3to2_data_panel_open.png';
import LandingPage from '../media/Landing Page.png';
import VariableChangeDemo from '../media/Variable Change Demo.gif';
import UncdfCountry from '../media/country.png';
import UncdfMap from '../media/map.png';
import UncdfMetric from '../media/metric.png';
...
import NasaLogo from '../media/nasa.png';
import HarvardLogo from '../media/harvard.png';
import T4SGLogo from '../media/t4sg.png';
